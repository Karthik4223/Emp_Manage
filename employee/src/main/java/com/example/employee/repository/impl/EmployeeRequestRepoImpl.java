...
public class EmployeeRequestRepoImpl implements EmployeeRequestRepo{
	...
	@Override
	public boolean updateEmployeeRequestStatus(Integer emp_RequestId, EmployeeRequestStatus newStatus, String updatedBy,String empCode) throws EmployeeException {
	...
	private boolean logEmployeeRequest(EmployeeRequest employeeRequest) {
		String sqlEmployeReq = " Select emp_RequestId,email,department,name,phone_number,gender,country,state,city,emp_RequestStatus,createdDateTime,updatedDateTime,createdBy,updatedBy,sysTime,emp_code from EmployeeRequests "
				+ "where emp_RequestId=:emp_RequestId";
